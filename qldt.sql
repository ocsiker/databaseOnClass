...
USE QLTGDT
GO
--Create the whole tables
CREATE TABLE GIAOVIEN (
	magv char (5), 
	hoten nvarchar(40), 
	luong float, 
	phai nchar(3) CHECK (phai = 'Nam' OR phai = N'Nữ'), 
	ngaysinh datetime, 
	diachi nvarchar(100), 
	gvqlcm char(5), 
	mabm nchar(5),
...
CREATE TABLE KHOA (
	makhoa char(4), 
	tenkhoa nvarchar(40), 
	namtl int CHECK (1900 <= namtl AND namtl <= 2300), 
	phong char(5), 
	dienthoai char(12), 	
	truongkhoa char(5), 
	ngaynhanchuc datetime,
...
CREATE TABLE NGUOITHAN (
	...
	ten nvarchar(20), 
	ngsinh datetime, 
	phai nvarchar(3) CHECK (phai = 'Nam' OR phai = N'Nữ'),
...
INSERT INTO BOMON VALUES
	...
	(N'HTTT',N'Hệ thống thông tin','B13','0838125125',null,'CNTT','09/20/2004'),
...
INSERT INTO GIAOVIEN VALUES
	('001',N'Nguyễn Hoài An',2000,N'Nam','02/15/1973',N'25/3 Lạc Long Quân, Q.10, TP HCM', null, N'MMT'),
...
INSERT INTO DETAI (MADT, TENDT, KINHPHI, CAPQL, NGAYBD, NGAYKT, MACD, GVCNDT) VALUES
	('001',N'HTTT quản lý các trường ĐH',20,N'ĐHQG','10/20/2007','10/20/2008',N'QLGD','002'),
